...
splitted = asp['Date'].str.split('-', expand=True)
 
asp['month'] = splitted[1].astype('int')
asp['year'] = splitted[0].astype('int')
asp['day'] = splitted[2].astype('int')
