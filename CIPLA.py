...
splitted = cipla['Date'].str.split('-', expand=True)
 
cipla['month'] = splitted[1].astype('int')
cipla['year'] = splitted[0].astype('int')
cipla['day'] = splitted[2].astype('int')
