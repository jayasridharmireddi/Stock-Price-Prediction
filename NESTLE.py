...
splitted = nestle['Date'].str.split('-', expand=True)
 
nestle['month'] = splitted[1].astype('int')
nestle['year'] = splitted[0].astype('int')
nestle['day'] = splitted[2].astype('int')
